...
// new + inicializar miembros en la función constructora
...
function Interval(min, max) {
  ...
  // returns new interval: min is the biggest, and max is the lowest
...
consoleMPDS.write(
    tests.map(testFunction => intervals.map(testFunction)
                        .reduce((accumulatedMsg, intervalTestResul) => `${accumulatedMsg}${intervalTestResul}\n`, ``)

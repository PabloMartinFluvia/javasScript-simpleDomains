...
const isKingMovement = absHorizontalShift <= MAX_SHIFT   &&   absVerticalShift <= MAX_SHIFT;

console.writeln(`
La coordenada origen (${abcissaOrigin}, ${ordinateOrigin}) y la coordenada destino \
(${abcissaTarget}, ${ordinateTarget}) ${isKingMovement ? "si" : "no"} es un movimiento del rey`);